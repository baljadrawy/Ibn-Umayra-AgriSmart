...
const crops = [
  { id: 1, name: "طماطم", category: "خضروات", water: "متوسط", temp: "20-30°م", time: "90 يوم", image: "https://picsum.photos/seed/tomato/400/300" },
  { id: 2, name: "فلفل رومي", category: "خضروات", water: "كثير", temp: "22-32°م", time: "110 يوم", image: "https://picsum.photos/seed/pepper/400/300" },
  { id: 3, name: "بقدونس", category: "ورقيات", water: "كثير", temp: "15-25°م", time: "45 يوم", image: "https://picsum.photos/seed/parsley/400/300" },
  { id: 4, name: "برسيم", category: "أعلاف", water: "كثير جداً", temp: "10-35°م", time: "30 يوم", image: "https://picsum.photos/seed/alfalfa/400/300" },
  { id: 5, name: "نخل", category: "أشجار", water: "متوسط", temp: "25-45°م", time: "سنوات", image: "https://picsum.photos/seed/palm/400/300" },
  { id: 6, name: "عنب", category: "فواكه", water: "قليل", temp: "18-35°م", time: "سنوات", image: "https://picsum.photos/seed/grapes/400/300" },
];

export default function CropsGuide() {
  const [search, setSearch] = useState('');

  const filteredCrops = crops.filter(c => c.name.includes(search));
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredCrops.map((crop) => (
          <Card key={crop.id} className="overflow-hidden group hover:shadow-xl transition-all duration-300 border-none shadow-md">
            ...
            <CardContent className="pt-6">
              ...
              <div className="flex gap-2">
                <Button className="flex-1 bg-primary">جدول الزراعة</Button>
                <Button variant="outline" className="flex-1">استشر الذكاء</Button>
              </div>
            </CardContent>
          </Card>
        ))}
